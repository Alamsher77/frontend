...
import {useState} from 'react'
  const Conformation = ({islodding,children,onCancel,onClose,onconform,isvisible})=>{ 
  ...
  return (
     ...
     <div className="flex pt-2 w-full justify-evenly">
      <button disabled={islodding} onClick={onconform} className="px-6 rounded-xl  font-bold py-2 bg-green-600 text-white">{islodding ? 'lodding':'ok'}</button>
